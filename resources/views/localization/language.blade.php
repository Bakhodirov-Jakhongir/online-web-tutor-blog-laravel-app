...
<html>
<head>
    <title>Multi Languages Laravel</title>
    <meta charset="utf-8">
...
<body>
    <div class="container">
        <div class="row" style="text-align: center;margin-top: 40px;">
            <h2>How to Create Multi Language Website in Laravel</h2><br>
            ...
            <div class="col-md-4">
                <select class="form-control Langchange">
                    ...
                    <option value="uzb" {{ session()->get('locale') == 'uzb' ? 'selected' : '' }}>Uzbek</option>
                </select>
            </div>
